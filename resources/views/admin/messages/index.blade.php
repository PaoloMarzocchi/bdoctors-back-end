...
@section('content')
  <div class="container my-3">
    ...
    <div class="wrapper bg_dark_transparent w-100 p-4 mb-4 shadow rounded-lg">
      ...
      <h4 class="mb-4">Hi Dr. <span class="my_primary text-decoration-underline">{{ $doctor->surname }}</span>, you have
                      ...
                      <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title mx-auto" id="modalTitleId-{{ $message->id }}">
                          ...
                          <div class="modal-footer mx-auto">
                            <button type="button" class="btn btn-secondary py-1 px-3 rounded-pill my-3"
