      ...
      <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center mb-4">
        <div class="doctor_header">
          ...
          <div class="doctor_actions flex-sm-row">
            ...
            <a class="btn my_btn_secondary px-4 rounded-pill text-decoration-none shadow responsive-btn" target="_blank"
      ...
      <div class="row gy-4">
        ...
        <div class="col-12 col-xl-6">
          <div class="card h-100 shadow rounded-4 p-2">
            ...
            @else
              <img class="img-fluid rounded-3" style="object-fit: cover;" loading="lazy" src="/img/no-image.jpg"
                alt="">
            @endif
          </div>
        </div>
                  ...
                  <form action="{{ route('admin.doctorProfile.update', $doctorProfile) }}" method="post"
                    ...
                    <div class="input-group">
                      <textarea class="form-control rounded-end-0 @error('services') is-invalid @enderror" name="services" id="services"
                        aria-describedby="servicesHelpId" placeholder="Your Services" rows="2">{{ old('services', $doctorProfile->services) }}</textarea>
