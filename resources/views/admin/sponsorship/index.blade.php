  ...
  <div class="container py-4">
    ...
    <div class="wrapper w-100 p-4 mb-4 shadow rounded-lg">
      ...
      <div class="pricing-header pb-md-4">
        <p class="fs-5">
          Highlight your profile! Purchase sponsorships to boost your visibility and reach more users. Take your presence
            ...
            <div class="card mb-4 rounded-4 shadow-sm border-0">
              <form action="{{ route('admin.sponsorship.store') }}" method="post">
                ...
                <div class="card-body d-flex flex-column gap-2">
                  ...
                  <button class="btn my_btn_primary px-4 rounded-pill mx-auto" type="submit">Get this
                    Sponsorship</button>
