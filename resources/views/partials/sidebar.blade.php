<div class="sidebar rounded-3 shadow d-flex flex-column flex-shrink-0 p-3 m-2">
  ...
  <ul class="nav nav-pills flex-column mb-auto gap-1">
    ...
    <li
      class="nav-item d-flex align-items-baseline ps-2 {{ Route::currentRouteName() === 'admin.statistics.index2' ? 'active' : '' }}">
      <i class="fa-solid fa-chart-line"></i>
      <a href="{{ route('admin.statistics.index2') }}"
        class="nav-link py-1 ps-2 {{ Route::currentRouteName() === 'admin.statistics.index2' ? 'active' : '' }} ">
        {{ __('Statistics_2') }}
      </a>
    </li>
