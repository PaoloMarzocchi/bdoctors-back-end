<div class="container">
  ...
  <form action="{{ route('admin.doctorProfile.update', $doctorProfile) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="">
      ...
      <object height="150" data="{{ 'http://127.0.0.1:8000/storage/' . $doctorProfile->cv }}" type=""></object>
    </div>
    ...
    <div class="">
      ...
      @if ($doctorProfile->photo)
        <div class="overflow-auto" style="height: 150px; width:300px">
          <object height="" width="300" data="{{ 'http://127.0.0.1:8000/storage/' . $doctorProfile->photo }}"
            type=""></object>
        </div>
      @endif
    </div>
