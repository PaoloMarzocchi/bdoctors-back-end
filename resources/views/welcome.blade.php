...
@section('content')
  <div class="text-center bg-body-tertiary rounded-3">
    ...
    <div class="logo_laravel d-flex justify-content-center my_logo">
      <img width="500px" src="./img/BDoctors_transparent.png" alt="">
    </div>

    <h1 class="text-body-emphasis">Welcome to BDoctors, new User !</h1>
    <p class="col-lg-8 mx-auto fs-5 text-muted">
      Welcome to your personal area. Manage your account, update your information, and access exclusive resources for
      registered doctors. Enhance your professional experience with just a few clicks </p>
